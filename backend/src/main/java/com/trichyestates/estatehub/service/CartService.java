...
/** Database-backed cart / shortlist. Every method takes the user id from the authenticated principal, so users only ever see their own rows. */
@Service
@Transactional
public class CartService {
    ...
    public CartService(CartItemRepository repository, PropertyRepository propertyRepository,
    ...
    public boolean add(Long userId, Long propertyId) {
        ...
        repository.save(new CartItem(userRepository.getReferenceById(userId), property));
        return true;
    }
